...
public class Scene_Test
{
    ...
    [TestCase(0.5F, 1F, 40, 76, 3, -3, 48, 72, -2, 4, TestName = "Collide Straight (Different Masses)")]
    [TestCase(1F, 1F, 40, 36, 4, -2, 15, 46, -2, 4, TestName = "Collide Straight (Different Speeds)")]
